...
export default function Footer({ onNavigate, currentPage }: FooterProps) {
  ...
  return (
    <footer className="bg-black text-white py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden font-geist mt-[-2px]">
      {/* Subtle Glowing Accents */}
      <div className="absolute top-0 left-1/4 w-[400px] h-[400px] bg-[#FF7518]/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-[300px] h-[300px] bg-[#FF7518]/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto relative z-10 pb-4">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-x-8 gap-y-12">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-2 space-y-6">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <a 
                ...
                className="flex items-center gap-3 px-5 py-3 bg-white/5 hover:bg-white/10 text-white rounded-xl transition-all border border-white/10 hover:border-[#FF7518]/50 shadow-md"
              >
                ...
                <div className="text-left">
                  <div className="text-[10px] font-medium leading-none mb-1 text-white/50">GET IT ON</div>
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-[10px] font-medium leading-none mb-1 text-white/50">Download on the</div>
            ...
            <div className="pt-8 mt-6 border-t border-white/10">
              <div className="flex flex-col sm:flex-row sm:items-center gap-6 pb-2">
                <div className="flex gap-3">
                  <a href="#" className="w-10 h-10 rounded-full bg-white/5 hover:bg-[#FF7518] flex items-center justify-center text-white transition-all hover:scale-110">
                ...
                <p className="text-xs font-medium text-white/40 mt-1 sm:mt-0">
          ...
          <div className="col-span-1">
            <h5 className="text-white font-bold text-sm mb-4">Services</h5>
                ...
                (item) => (
                  <li key={item}>
                    <a 
                      ...
                      className="text-white/60 hover:text-[#FF7518] transition-colors block"
                    >
                      {item}
                    </a>
                  </li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3 text-[13px] font-medium">
              <li>
                <a href="#" className="text-white/60 hover:text-[#FF7518] transition-colors block">About Shata</a>
              </li>
              <li>
                <a href="#events" onClick={(e) => handlePageNavigation(e, 'events')} className="text-white/60 hover:text-[#FF7518] transition-colors block">Events</a>
              </li>
              <li>
                <a href="#why-shata" onClick={(e) => handlePageNavigation(e, 'why-shata')} className="text-white/60 hover:text-[#FF7518] transition-colors block">Why Shata</a>
              </li>
              <li>
                <a href="#contact" onClick={(e) => handlePageNavigation(e, 'contact')} className="text-white/60 hover:text-[#FF7518] transition-colors block">Contact Us</a>
              </li>
              <li>
                <a href="#" className="text-white/60 hover:text-[#FF7518] transition-colors block">Press & Media</a>
              </li>
            </ul>
          </div>
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            <h5 className="text-white font-bold text-sm mb-4 mt-2 md:mt-0 lg:mt-0">Support</h5>
            <ul className="space-y-3 text-[13px] font-medium">
              {['Help Center', 'Refund Policy', 'Terms of Service', 'Privacy Policy', 'Security Audit'].map(
                (item) => (
                  <li key={item}>
                    <a href="#" className="text-white/60 hover:text-[#FF7518] transition-colors block">
                      {item}
                    </a>
                  </li>
                )
