          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-2 space-y-4">
            ...
            <div className="flex flex-wrap gap-3 pt-4">
              <a 
                ...
                className="flex items-center gap-3 px-5 py-2.5 bg-gradient-to-r from-orange-500 to-amber-500 text-white rounded-xl hover:from-orange-600 hover:to-amber-600 hover:-translate-y-0.5 transition-all shadow-md border border-orange-400/50"
              >
            ...
            <div className="pt-6 mt-2 border-t border-slate-900/10">
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 pb-6">
                ...
                <p className="text-xs font-medium text-slate-900/60 mt-1 sm:mt-0">
